...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <img src="/storage/logo/logoazul.jpg"
             alt="logo"
             style="width: 500px">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('login') }}"
                                                                                     class="underline text-gray-900 dark:text-white">Conectarse</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('register') }}"
                                                                                         class="underline text-gray-900 dark:text-white">Registrate</a>
                                    </div>
                                </div>
                            </div>
                        @endif
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                Auto Express Aguila S.A. de C.V. ----- Alpha v0.1
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0 flex">
