                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="sm:flex-auto">
                                <h1 class="text-xl font-semibold text-gray-900">Lista de Evaluados</h1>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                @foreach($peoples as $item)
                                    <tr>
                                        ...
                                        <td class="ml-4 py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="font-medium text-gray-900"> 100
                                            </div>

                                        </td>

                                        <td class="ml-4 py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="font-medium text-gray-900">{{ $item->created_at }}
                                            </div>
