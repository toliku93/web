<div wire:init="loadCategory">
                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                ...
                                <div class="sm:flex-auto">
                                    <h1 class="text-xl font-semibold text-gray-900">Catalogo de Categorias</h1>
                                </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td class="ml-4 py-4 pl-4 pr-3 text-right text-sm sm:pl-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            Livewire.on('borra', categoryId => {
                Swal.fire({
                    title: 'Estas Seguro?',
                    text: "No hay manera de revertir esto!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('index-category', 'borrar', categoryId);
